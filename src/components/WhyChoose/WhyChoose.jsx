...
const WhyChoose = () => {
    ...
    bg-gray-50'>
                <div className='container'>
                    ...
                    <h1 data-aos="fade"
                    className='pb-16
                           tracking-wider text-2xl font-semibold text-dark text-center'>Why Choose Us</h1>
                    {/* card section  */}
                    <div data-aos="fade"data-aos-delay="300">
                        <div className='grid grid-cols-2 md:grid-cols-4
                            ...
                            items-center flex-col gap-2 px-2'>
                                <p className='text-dark/70 font-semibold'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Id, cum?
                                </p>
                            ...
                            items-center flex-col gap-2 px-2'>
                                ...
                                <p className='text-5xl rotate-90
                                text-primary text-center flex-col translate-x-5'>....
                                </p>
